...
const TopBanner = () => {
  const benefits = [
    {
      id: 1,
      text: "Control operational costs",
    },
    {
      id: 2,
      text: "Absorb jumps in demand",
    },
    {
      id: 3,
      text: "Meet customer expectations",
    },
  ];
    ...
    <section className="bg-gray-50 py-16 md:py-20 w-full mx-auto">
        <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-sm md:text-base uppercase tracking-wider text-purple-600 font-medium mb-4">
                ROUTE PLANNING APIs FOR MARGIN-SENSITIVE LOGISTICS
            </p>

            {/* Main heading - split into multiple lines for styling */}
            <h1 className="text-3xl md:text-5xl font-bold mb-12">
                <div className="bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-transparent mb-2">
                    Plan multi-stop delivery routes
                </div>
                <div className="text-gray-900">
                    with dream constraints (but without
                    <br />
                    nightmares in your API bills)
                </div>
            </h1>
            ...
            <div className="flex justify-center mb-8">
                <button className="flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg transition-all hover:shadow-xl">
                    <div className="text-left">
                        <span className="font-medium">Request a live demo</span>
                        <br />
            ...
            <a
                href="#demos"
                className="inline-block text-purple-600 hover:text-purple-700 border-b border-purple-600 pb-1 transition-colors"
            >
                Watch Product Demos
            </a>
        </div>
